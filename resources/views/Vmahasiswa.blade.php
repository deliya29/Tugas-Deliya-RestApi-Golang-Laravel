...
@section('Content')
            ...
            <div class="modal-dialog ">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <input type="button" class="btn btn-success" id="btn-tambah" value="Save">
                    </div>
                </div>
            </div>
        </div>
    ...
    <script>
        ...
        function ModalEditMahasiwa(id, name, phone, address) {

            $('[name="npm_e"]').val(id);
            $('[name="n_mahasiswa_e"]').val(name);
            $('[name="hp_mahasiswa_e"]').val(phone);
            $('[name="a_mahasiswa_e"]').val(address);
        ...
        $("#btn-tambah").on('click', function() {
            ...
            let name = $('[name="n_mahasiswa"]').val();
            let phone = $('[name="hp_mahasiswa"]').val();
            let address = $('[name="a_mahasiswa"]').val();
            $.ajax({
                method: 'POST',
        ...
        $("#btn-ubah").on('click', function() {
            ...
            let name = $('[name="n_mahasiswa_e"]').val();
            let phone = $('[name="hp_mahasiswa_e"]').val();
            let address = $('[name="a_mahasiswa_e"]').val();
            console.log(npm+name+address+phone);
            $.ajax({
                method: 'PUT',
